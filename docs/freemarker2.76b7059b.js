...
parcelRegister("gZ6kj", function(module, exports) {

$parcel$export(module.exports, "TagAngleInterpolationDollar", () => $c5d7402ff7e9b212$export$9945f5d7c02ad2fc);
$parcel$export(module.exports, "TagBracketInterpolationDollar", () => $c5d7402ff7e9b212$export$6f4f6c4e91d5ee59);
$parcel$export(module.exports, "TagAngleInterpolationBracket", () => $c5d7402ff7e9b212$export$1cb623f6377415e8);
$parcel$export(module.exports, "TagBracketInterpolationBracket", () => $c5d7402ff7e9b212$export$d0605717f8750fe2);
$parcel$export(module.exports, "TagAutoInterpolationDollar", () => $c5d7402ff7e9b212$export$b685ef20e1dddf83);
$parcel$export(module.exports, "TagAutoInterpolationBracket", () => $c5d7402ff7e9b212$export$d2238c7b2ec81a45);
/*!-----------------------------------------------------------------------------
...
var $c5d7402ff7e9b212$var$__defProp = Object.defineProperty;
var $c5d7402ff7e9b212$var$__getOwnPropDesc = Object.getOwnPropertyDescriptor;
var $c5d7402ff7e9b212$var$__getOwnPropNames = Object.getOwnPropertyNames;
var $c5d7402ff7e9b212$var$__hasOwnProp = Object.prototype.hasOwnProperty;
var $c5d7402ff7e9b212$var$__copyProps = (to, from, except, desc)=>{
    if (from && typeof from === "object" || typeof from === "function") {
        for (let key of $c5d7402ff7e9b212$var$__getOwnPropNames(from))if (!$c5d7402ff7e9b212$var$__hasOwnProp.call(to, key) && key !== except) $c5d7402ff7e9b212$var$__defProp(to, key, {
            get: ()=>from[key],
            enumerable: !(desc = $c5d7402ff7e9b212$var$__getOwnPropDesc(from, key)) || desc.enumerable
        });
    }
    return to;
};
var $c5d7402ff7e9b212$var$__reExport = (target, mod, secondTarget)=>($c5d7402ff7e9b212$var$__copyProps(target, mod, "default"), secondTarget && $c5d7402ff7e9b212$var$__copyProps(secondTarget, mod, "default"));
// src/fillers/monaco-editor-core.ts
var $c5d7402ff7e9b212$var$monaco_editor_core_exports = {};
$c5d7402ff7e9b212$var$__reExport($c5d7402ff7e9b212$var$monaco_editor_core_exports, $6QSpz);
// src/basic-languages/freemarker2/freemarker2.ts
var $c5d7402ff7e9b212$var$EMPTY_ELEMENTS = [
    "assign",
    "flush",
    "ftl",
    "return",
...
var $c5d7402ff7e9b212$var$BLOCK_ELEMENTS = [
    "attempt",
    "autoesc",
    "autoEsc",
    "compress",
...
var $c5d7402ff7e9b212$var$TagSyntaxAngle = {
    close: ">",
    id: "angle",
    open: "<"
};
var $c5d7402ff7e9b212$var$TagSyntaxBracket = {
    close: "\\]",
    id: "bracket",
    open: "\\["
};
var $c5d7402ff7e9b212$var$TagSyntaxAuto = {
    close: "[>\\]]",
    id: "auto",
    open: "[<\\[]"
};
var $c5d7402ff7e9b212$var$InterpolationSyntaxDollar = {
    close: "\\}",
    id: "dollar",
    open1: "\\$",
    open2: "\\{"
};
var $c5d7402ff7e9b212$var$InterpolationSyntaxBracket = {
    close: "\\]",
    id: "bracket",
    open1: "\\[",
    open2: "="
};
function $c5d7402ff7e9b212$var$createLangConfiguration(ts) {
    return {
        brackets: [
            [
                "<",
        ...
        folding: {
            markers: {
                start: new RegExp(`${ts.open}#(?:${$c5d7402ff7e9b212$var$BLOCK_ELEMENTS.join("|")})([^/${ts.close}]*(?!/)${ts.close})[^${ts.open}]*$`),
                end: new RegExp(`${ts.open}/#(?:${$c5d7402ff7e9b212$var$BLOCK_ELEMENTS.join("|")})[\\r\\n\\t ]*>`)
            }
        },
        onEnterRules: [
            {
                beforeText: new RegExp(`${ts.open}#(?!(?:${$c5d7402ff7e9b212$var$EMPTY_ELEMENTS.join("|")}))([a-zA-Z_]+)([^/${ts.close}]*(?!/)${ts.close})[^${ts.open}]*$`),
                afterText: new RegExp(`^${ts.open}/#([a-zA-Z_]+)[\\r\\n\\t ]*${ts.close}$`),
                action: {
                    indentAction: $c5d7402ff7e9b212$var$monaco_editor_core_exports.languages.IndentAction.IndentOutdent
                }
            },
            {
                beforeText: new RegExp(`${ts.open}#(?!(?:${$c5d7402ff7e9b212$var$EMPTY_ELEMENTS.join("|")}))([a-zA-Z_]+)([^/${ts.close}]*(?!/)${ts.close})[^${ts.open}]*$`),
                action: {
                    indentAction: $c5d7402ff7e9b212$var$monaco_editor_core_exports.languages.IndentAction.Indent
                }
            }
        ]
    };
}
function $c5d7402ff7e9b212$var$createLangConfigurationAuto() {
    return {
        ...
        folding: {
            markers: {
                start: new RegExp(`[<\\[]#(?:${$c5d7402ff7e9b212$var$BLOCK_ELEMENTS.join("|")})([^/>\\]]*(?!/)[>\\]])[^<\\[]*$`),
                end: new RegExp(`[<\\[]/#(?:${$c5d7402ff7e9b212$var$BLOCK_ELEMENTS.join("|")})[\\r\\n\\t ]*>`)
            }
        },
        onEnterRules: [
            {
                beforeText: new RegExp(`[<\\[]#(?!(?:${$c5d7402ff7e9b212$var$EMPTY_ELEMENTS.join("|")}))([a-zA-Z_]+)([^/>\\]]*(?!/)[>\\]])[^[<\\[]]*$`),
...
function $c5d7402ff7e9b212$var$createMonarchLanguage(ts, is) {
...
function $c5d7402ff7e9b212$var$createMonarchLanguageAuto(is) {
    const angle = $c5d7402ff7e9b212$var$createMonarchLanguage($c5d7402ff7e9b212$var$TagSyntaxAngle, is);
    const bracket = $c5d7402ff7e9b212$var$createMonarchLanguage($c5d7402ff7e9b212$var$TagSyntaxBracket, is);
    const auto = $c5d7402ff7e9b212$var$createMonarchLanguage($c5d7402ff7e9b212$var$TagSyntaxAuto, is);
    return {
...
var $c5d7402ff7e9b212$export$9945f5d7c02ad2fc = {
    conf: $c5d7402ff7e9b212$var$createLangConfiguration($c5d7402ff7e9b212$var$TagSyntaxAngle),
    language: $c5d7402ff7e9b212$var$createMonarchLanguage($c5d7402ff7e9b212$var$TagSyntaxAngle, $c5d7402ff7e9b212$var$InterpolationSyntaxDollar)
};
var $c5d7402ff7e9b212$export$6f4f6c4e91d5ee59 = {
    conf: $c5d7402ff7e9b212$var$createLangConfiguration($c5d7402ff7e9b212$var$TagSyntaxBracket),
    language: $c5d7402ff7e9b212$var$createMonarchLanguage($c5d7402ff7e9b212$var$TagSyntaxBracket, $c5d7402ff7e9b212$var$InterpolationSyntaxDollar)
};
var $c5d7402ff7e9b212$export$1cb623f6377415e8 = {
    conf: $c5d7402ff7e9b212$var$createLangConfiguration($c5d7402ff7e9b212$var$TagSyntaxAngle),
    language: $c5d7402ff7e9b212$var$createMonarchLanguage($c5d7402ff7e9b212$var$TagSyntaxAngle, $c5d7402ff7e9b212$var$InterpolationSyntaxBracket)
};
var $c5d7402ff7e9b212$export$d0605717f8750fe2 = {
    conf: $c5d7402ff7e9b212$var$createLangConfiguration($c5d7402ff7e9b212$var$TagSyntaxBracket),
    language: $c5d7402ff7e9b212$var$createMonarchLanguage($c5d7402ff7e9b212$var$TagSyntaxBracket, $c5d7402ff7e9b212$var$InterpolationSyntaxBracket)
};
var $c5d7402ff7e9b212$export$b685ef20e1dddf83 = {
    conf: $c5d7402ff7e9b212$var$createLangConfigurationAuto(),
    language: $c5d7402ff7e9b212$var$createMonarchLanguageAuto($c5d7402ff7e9b212$var$InterpolationSyntaxDollar)
};
var $c5d7402ff7e9b212$export$d2238c7b2ec81a45 = {
    conf: $c5d7402ff7e9b212$var$createLangConfigurationAuto(),
    language: $c5d7402ff7e9b212$var$createMonarchLanguageAuto($c5d7402ff7e9b212$var$InterpolationSyntaxBracket)
};
