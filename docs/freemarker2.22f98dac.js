...
parcelRegister("dmQqc", function(module, exports) {

$parcel$export(module.exports, "TagAngleInterpolationDollar", () => $9bb5fe3f2ace4496$export$9945f5d7c02ad2fc);
$parcel$export(module.exports, "TagBracketInterpolationDollar", () => $9bb5fe3f2ace4496$export$6f4f6c4e91d5ee59);
$parcel$export(module.exports, "TagAngleInterpolationBracket", () => $9bb5fe3f2ace4496$export$1cb623f6377415e8);
$parcel$export(module.exports, "TagBracketInterpolationBracket", () => $9bb5fe3f2ace4496$export$d0605717f8750fe2);
$parcel$export(module.exports, "TagAutoInterpolationDollar", () => $9bb5fe3f2ace4496$export$b685ef20e1dddf83);
$parcel$export(module.exports, "TagAutoInterpolationBracket", () => $9bb5fe3f2ace4496$export$d2238c7b2ec81a45);
/*!-----------------------------------------------------------------------------
...
var $9bb5fe3f2ace4496$var$__defProp = Object.defineProperty;
var $9bb5fe3f2ace4496$var$__getOwnPropDesc = Object.getOwnPropertyDescriptor;
var $9bb5fe3f2ace4496$var$__getOwnPropNames = Object.getOwnPropertyNames;
var $9bb5fe3f2ace4496$var$__hasOwnProp = Object.prototype.hasOwnProperty;
var $9bb5fe3f2ace4496$var$__copyProps = (to, from, except, desc)=>{
    if (from && typeof from === "object" || typeof from === "function") {
        for (let key of $9bb5fe3f2ace4496$var$__getOwnPropNames(from))if (!$9bb5fe3f2ace4496$var$__hasOwnProp.call(to, key) && key !== except) $9bb5fe3f2ace4496$var$__defProp(to, key, {
            get: ()=>from[key],
            enumerable: !(desc = $9bb5fe3f2ace4496$var$__getOwnPropDesc(from, key)) || desc.enumerable
        });
    }
    return to;
};
var $9bb5fe3f2ace4496$var$__reExport = (target, mod, secondTarget)=>($9bb5fe3f2ace4496$var$__copyProps(target, mod, "default"), secondTarget && $9bb5fe3f2ace4496$var$__copyProps(secondTarget, mod, "default"));
// src/fillers/monaco-editor-core.ts
var $9bb5fe3f2ace4496$var$monaco_editor_core_exports = {};
$9bb5fe3f2ace4496$var$__reExport($9bb5fe3f2ace4496$var$monaco_editor_core_exports, $leKFq);
// src/basic-languages/freemarker2/freemarker2.ts
var $9bb5fe3f2ace4496$var$EMPTY_ELEMENTS = [
    "assign",
    "flush",
    "ftl",
    "return",
...
var $9bb5fe3f2ace4496$var$BLOCK_ELEMENTS = [
    "attempt",
    "autoesc",
    "autoEsc",
    "compress",
...
var $9bb5fe3f2ace4496$var$TagSyntaxAngle = {
    close: ">",
    id: "angle",
    open: "<"
};
var $9bb5fe3f2ace4496$var$TagSyntaxBracket = {
    close: "\\]",
    id: "bracket",
    open: "\\["
};
var $9bb5fe3f2ace4496$var$TagSyntaxAuto = {
    close: "[>\\]]",
    id: "auto",
    open: "[<\\[]"
};
var $9bb5fe3f2ace4496$var$InterpolationSyntaxDollar = {
    close: "\\}",
    id: "dollar",
    open1: "\\$",
    open2: "\\{"
};
var $9bb5fe3f2ace4496$var$InterpolationSyntaxBracket = {
    close: "\\]",
    id: "bracket",
    open1: "\\[",
    open2: "="
};
function $9bb5fe3f2ace4496$var$createLangConfiguration(ts) {
    return {
        brackets: [
            [
                "<",
        ...
        folding: {
            markers: {
                start: new RegExp(`${ts.open}#(?:${$9bb5fe3f2ace4496$var$BLOCK_ELEMENTS.join("|")})([^/${ts.close}]*(?!/)${ts.close})[^${ts.open}]*$`),
                end: new RegExp(`${ts.open}/#(?:${$9bb5fe3f2ace4496$var$BLOCK_ELEMENTS.join("|")})[\\r\\n\\t ]*>`)
            }
        },
        onEnterRules: [
            {
                beforeText: new RegExp(`${ts.open}#(?!(?:${$9bb5fe3f2ace4496$var$EMPTY_ELEMENTS.join("|")}))([a-zA-Z_]+)([^/${ts.close}]*(?!/)${ts.close})[^${ts.open}]*$`),
                afterText: new RegExp(`^${ts.open}/#([a-zA-Z_]+)[\\r\\n\\t ]*${ts.close}$`),
                action: {
                    indentAction: $9bb5fe3f2ace4496$var$monaco_editor_core_exports.languages.IndentAction.IndentOutdent
                }
            },
            {
                beforeText: new RegExp(`${ts.open}#(?!(?:${$9bb5fe3f2ace4496$var$EMPTY_ELEMENTS.join("|")}))([a-zA-Z_]+)([^/${ts.close}]*(?!/)${ts.close})[^${ts.open}]*$`),
                action: {
                    indentAction: $9bb5fe3f2ace4496$var$monaco_editor_core_exports.languages.IndentAction.Indent
                }
            }
        ]
    };
}
function $9bb5fe3f2ace4496$var$createLangConfigurationAuto() {
    return {
        ...
        folding: {
            markers: {
                start: new RegExp(`[<\\[]#(?:${$9bb5fe3f2ace4496$var$BLOCK_ELEMENTS.join("|")})([^/>\\]]*(?!/)[>\\]])[^<\\[]*$`),
                end: new RegExp(`[<\\[]/#(?:${$9bb5fe3f2ace4496$var$BLOCK_ELEMENTS.join("|")})[\\r\\n\\t ]*>`)
            }
        },
        onEnterRules: [
            {
                beforeText: new RegExp(`[<\\[]#(?!(?:${$9bb5fe3f2ace4496$var$EMPTY_ELEMENTS.join("|")}))([a-zA-Z_]+)([^/>\\]]*(?!/)[>\\]])[^[<\\[]]*$`),
...
function $9bb5fe3f2ace4496$var$createMonarchLanguage(ts, is) {
...
function $9bb5fe3f2ace4496$var$createMonarchLanguageAuto(is) {
    const angle = $9bb5fe3f2ace4496$var$createMonarchLanguage($9bb5fe3f2ace4496$var$TagSyntaxAngle, is);
    const bracket = $9bb5fe3f2ace4496$var$createMonarchLanguage($9bb5fe3f2ace4496$var$TagSyntaxBracket, is);
    const auto = $9bb5fe3f2ace4496$var$createMonarchLanguage($9bb5fe3f2ace4496$var$TagSyntaxAuto, is);
    return {
...
var $9bb5fe3f2ace4496$export$9945f5d7c02ad2fc = {
    conf: $9bb5fe3f2ace4496$var$createLangConfiguration($9bb5fe3f2ace4496$var$TagSyntaxAngle),
    language: $9bb5fe3f2ace4496$var$createMonarchLanguage($9bb5fe3f2ace4496$var$TagSyntaxAngle, $9bb5fe3f2ace4496$var$InterpolationSyntaxDollar)
};
var $9bb5fe3f2ace4496$export$6f4f6c4e91d5ee59 = {
    conf: $9bb5fe3f2ace4496$var$createLangConfiguration($9bb5fe3f2ace4496$var$TagSyntaxBracket),
    language: $9bb5fe3f2ace4496$var$createMonarchLanguage($9bb5fe3f2ace4496$var$TagSyntaxBracket, $9bb5fe3f2ace4496$var$InterpolationSyntaxDollar)
};
var $9bb5fe3f2ace4496$export$1cb623f6377415e8 = {
    conf: $9bb5fe3f2ace4496$var$createLangConfiguration($9bb5fe3f2ace4496$var$TagSyntaxAngle),
    language: $9bb5fe3f2ace4496$var$createMonarchLanguage($9bb5fe3f2ace4496$var$TagSyntaxAngle, $9bb5fe3f2ace4496$var$InterpolationSyntaxBracket)
};
var $9bb5fe3f2ace4496$export$d0605717f8750fe2 = {
    conf: $9bb5fe3f2ace4496$var$createLangConfiguration($9bb5fe3f2ace4496$var$TagSyntaxBracket),
    language: $9bb5fe3f2ace4496$var$createMonarchLanguage($9bb5fe3f2ace4496$var$TagSyntaxBracket, $9bb5fe3f2ace4496$var$InterpolationSyntaxBracket)
};
var $9bb5fe3f2ace4496$export$b685ef20e1dddf83 = {
    conf: $9bb5fe3f2ace4496$var$createLangConfigurationAuto(),
    language: $9bb5fe3f2ace4496$var$createMonarchLanguageAuto($9bb5fe3f2ace4496$var$InterpolationSyntaxDollar)
};
var $9bb5fe3f2ace4496$export$d2238c7b2ec81a45 = {
    conf: $9bb5fe3f2ace4496$var$createLangConfigurationAuto(),
    language: $9bb5fe3f2ace4496$var$createMonarchLanguageAuto($9bb5fe3f2ace4496$var$InterpolationSyntaxBracket)
};

});


//# sourceMappingURL=freemarker2.22f98dac.js.map
